...
public class VWildComponent extends javax.swing.JPanel {
    private TextFile PkmnNames;
    private CTRMap Instance;
    private ArrayList<WBEnc> encs;
    
    public VWildComponent(CTRMap Instance, ArrayList<WBEnc> Encs) {
        initComponents();
    ...
    void LoadContainerSubEntry(int Index) {
        for (int EncIdx = 0; EncIdx < WBEnc.GRASS_ENC_SLOTS; ++EncIdx) {
            this.regGrassPanel.add(new VWildEncounterSlot(this.encs.get(Index).GetGrassEncounter(WBEnc.WBEncType.GRASS, EncIdx), PkmnNames));
        }
        for (int EncIdx = 0; EncIdx < WBEnc.GRASS_ENC_SLOTS; ++EncIdx) {
            this.doubleGrassPanel.add(new VWildEncounterSlot(this.encs.get(Index).GetGrassEncounter(WBEnc.WBEncType.GRASS_DOUBLE, EncIdx), this.PkmnNames));
        }
        for (int EncIdx = 0; EncIdx < WBEnc.GRASS_ENC_SLOTS; ++EncIdx) {
    ...
    private void initComponents() {
        ...
        jSubEntrySelector = new xstandard.gui.components.combobox.ComboBoxAndSpinner();
        jButton1 = new javax.swing.JButton();
        btnAddZoneData4 = new javax.swing.JButton();
        ...
        jSplitPane2.setLeftComponent(regularPanel1);
        ...
        jSplitPane2.setRightComponent(regularPanel2);
        ...
        jSplitPane1.setLeftComponent(regularPanel);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jSplitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1610, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        fileLoadPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Sub-Index"));
        ...
        jSubEntrySelector.setFont(new java.awt.Font("Droid Sans", 0, 12)); // NOI18N
        jSubEntrySelector.setMaximumRowCount(35);
        ...
        btnAddZoneData4.setText("-");
        btnAddZoneData4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddZoneData4ActionPerformed(evt);
            }
        });
        ...
        fileLoadPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(fileLoadPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jSubEntrySelector, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnAddZoneData3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnAddZoneData4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        fileLoadPanel3Layout.setVerticalGroup(
            fileLoadPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(fileLoadPanel3Layout.createSequentialGroup()
                .addGroup(fileLoadPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(fileLoadPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnAddZoneData3)
                        .addComponent(jButton1)
                        .addComponent(btnAddZoneData4)
                        .addComponent(jButton2))
                    .addComponent(jSubEntrySelector, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnAddZoneData4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddZoneData4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnAddZoneData4ActionPerformed
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.LoadContainerSubEntry(this.jSubEntrySelector.getValueSpinner());
    }//GEN-LAST:event_jButton2ActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAddZoneData3;
    private javax.swing.JButton btnAddZoneData4;
    ...
    private xstandard.gui.components.combobox.ComboBoxAndSpinner jSubEntrySelector;
