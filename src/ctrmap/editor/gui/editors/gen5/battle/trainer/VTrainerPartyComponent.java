...
public class VTrainerPartyComponent extends JPanel {
    ...
    public VTrainerPartyComponent(CTRMap Instance, WBTrainerPoke Pkmn,
            TextFile PkmnNames, TextFile ItemNames, TextFile MoveNames) {
        this(Instance, Pkmn, -1, PkmnNames, ItemNames, MoveNames, null);
    }
